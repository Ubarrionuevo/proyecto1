    ...
    <main className="min-h-screen bg-gradient-to-b from-pink-50 to-rose-100">
      ...
      <section className="min-h-[90vh] flex flex-col justify-center px-4 text-center relative">
        ...
        <div className="max-w-lg mx-auto pt-12">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-4">
            Hechos con amor para sorprender
          </p>
          ...
          {/* CTA PRINCIPAL */}
          <a
            href="https://wa.me/5493834903387?text=Hola! Quiero un ramo de golosinas. ¿Qué precios tienen?"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full text-sm sm:text-lg font-bold flex items-center justify-center gap-2 sm:gap-3 mx-auto shadow-xl hover:shadow-2xl transition-all hover:scale-105 w-full max-w-xs"
          >
          ...
          <p className="text-xs text-gray-500 mt-2">Responemos en minutos 💬</p>
        </div>
      </section>
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mt-4">
            <a
              href="https://wa.me/5493834903387?text=Hola! Quiero consultar por los precios de los ramos"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-full text-sm font-bold inline-flex items-center gap-2 shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
